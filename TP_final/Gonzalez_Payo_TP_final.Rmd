...
<img src="./Mapa.jpg" alt="JuveYell" width="1000px"/>
</p>
**Fig 2**: Mapa de Puntos Registrados
<div>
<br>
...
Para este estudio se utilizaron dos valores: ACI y ADI, ya que en un
analisis de correlación de los valores, se determinó que están menos
correlacionados y que responden a caracteristicas distintas de las
muestras (SC y dBFS).
...
Ind <- Cavernas %>% mutate(lugar = "Cavernas") %>% 
...
Datos_region_ADI <- yunga_ADI %>% mutate(region="Yunga") %>%
  bind_rows(puna_ADI %>% mutate(region = "Puna"))
...
![Sentinel_Anuros](./2021_05_20_20_19_01.mp3)
